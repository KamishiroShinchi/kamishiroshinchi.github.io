...
onMounted(() => {
    ...
    window.requestAnimationFrame(loop);
    rcard.value.importIllastration('/png/icon1.png', rcvt.value);
})
    ...
    <div id="maker" class="row-flex">
        ...
        <div id="editor" class="card">
            <div class="row-flex-center">
                <div class="btn greenBtn" @click="exportCard()">存</div>
            </div>

            <hr class="cardHr">
            <div class="row-flex-center">
                <div class="btn wideBtn" @click="importIll()">导</div>
            </div>
